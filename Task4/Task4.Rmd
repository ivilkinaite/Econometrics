...
vif(mod2)
```
##### Pastebime, kad garso izoliacija ir šilumos laidumas koreliuoja, nes vif>10. Vadinasi galime pašalinti vieną  iš kintamųjų. Pažiūrėsime, su kuriuo kintamuoju modelis yra geresnis.
```{r}
